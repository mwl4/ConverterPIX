...
namespace prism
{
	...
	enum class tobj_color_space_t : u8
	{
		srgb =						0,
		linear =					1,
	};

	enum class tobj_compress_t : u8
	{
		yes =						0,
		no =						1,
	};

	enum class tobj_anisotropic_t : u8
	{
		yes =						0,
		no =						1,
	};
	...
	struct tobj_header_t
	{
		...
		u8 m_bias;							// +22
		u8 m_unkn4_0;						// +23
		tobj_type_t m_type;					// +24
		u8 m_unkn5;							// +25 2 or 0
		mag_filter_t m_mag_filter;			// +26 Magnification filter: How the texture is sampled when a texel covers more than one pixel.
		min_filter_t m_min_filter;			// +27 Minification filter: How the texture is sampled when a texel covers less than one pixel.
		mip_filter_t m_mip_filter;			// +28
		u8 m_unkn6;							// +29 always 0?
		tobj_addr_t m_addr_u;				// +30
		tobj_addr_t m_addr_v;				// +31
		tobj_addr_t m_addr_w;				// +32
		tobj_compress_t m_compress;			// +33
		u8 m_unkn7;							// +34
		tobj_anisotropic_t m_anisotropic;	// +35
		u8 m_unkn9;							// +36
		u8 m_unkn10;						// +37
		tobj_color_space_t m_color_space;	// +38
		u8 m_unkn11;						// +39
