...
namespace prism
{
	namespace pmg_0x14
	{
		struct pmg_header_t // sizeof(104)
		{
			u8 m_version;								// +0
			u8 m_signature[3];							// +1
			i32 m_piece_count;							// +4
			...
			aabox_t m_bb;								// +40
			i32 m_skeleton_offset;						// +64
			i32 m_parts_offset;							// +68
			i32 m_locators_offset;						// +72
			i32 m_pieces_offset;						// +76
			i32 m_string_pool_offset;					// +80
			i32 m_string_pool_size;						// +84
			i32 m_vertex_pool_offset;					// +88
			i32 m_vertex_pool_size;						// +92
			i32 m_index_pool_offset;					// +96
			i32 m_index_pool_size;						// +100

			static const u8 SUPPORTED_VERSION = 0x14;
		};	ENSURE_SIZE(pmg_header_t, 104);
