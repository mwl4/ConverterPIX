...
bool Prefab::load(String filePath)
{
	...
	error_f("model", m_filePath, "Invalid version of prefab file (have: %i expected: %i or %i)", version,
			ppd_0x15::ppd_header_t::SUPPORTED_VERSION, ppd_0x16::ppd_header_t::SUPPORTED_VERSION);
